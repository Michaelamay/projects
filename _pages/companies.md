...
<body>
    ...
    <img src="/shipment-architecture.png"
     alt="Event-driven shipment lifecycle system architecture: Kafka publish-subscribe fan-out from four lifecycle topics (Booked, In Transit, Arrived, Delivered) to the team-owned Shipment Tracking Service and Notification Service, plus an ETA Calculation Service."
